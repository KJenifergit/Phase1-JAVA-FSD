...
public class Finalprojectphase1{
	public static void main(String[] args) {
		System.out.println("*****\n");
        System.out.println("\t      Welcome to The Desk of \n");
        System.out.println("\t           project.com   \n");
        System.out.println("\t      Developed by JENIFER K\n");
        System.out.println("*****\n");
        optionsSelection();
	}
	...
	public static void createWriteFile() throws IOException{
	    ...
	    File file=new File("C:\\Users\\admin\\jeniferjava\\project\\"+filename+".txt");
    ...
    {
        File file=new File("C:\\Users\\admin\\jeniferjava\\project");
        if(file.isDirectory())
        {
	...
	public static void deleteFile() throws Exception{
	    ...
	    File file=new File("C:\\Users\\admin\\jeniferjava\\project\\"+deletefile+".txt");
	...
	public static void searchFile() throws Exception {
		...
		File file=new File("C:\\Users\\admin\\jeniferjava\\project\\"+search+".txt");
		...
		while((data=reader.read())!=-1) {
			...
			System.out.println("Entered File is not Found-FNF");
